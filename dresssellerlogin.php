...
<img src="stymac.png">
<h1 align="center">Dress Seller Login</h1>

 <form method="post" action="designerregister.php">
	<div class="input-group">
  		<label>Username</label>
  		<input type="text" name="dressusername" required="required" >
  	</div>
  	<div class="input-group">
  		<label>Password</label>
  		<input type="password" name="dresspassword" required="required">
  	</div>
  	<div class="form-group">
<button class="btn btn-large btn-lg btn-success" type="submit" name="dresslogin" id="submit">Log in</button>
</div>
  	<p>
