				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							<input type="hidden" name="business" value="shoppingcart@stymac.com">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/StyMac/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="payment_success.php">
									<input type="hidden" name="cancel_return" value="payment_success.php"/>
